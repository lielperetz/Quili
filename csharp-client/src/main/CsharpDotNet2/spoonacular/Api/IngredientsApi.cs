...
namespace com.spoonacular
{
    ...
    public interface IIngredientsApi
    {
        ...
        /// <returns>List&lt;InlineResponse20024&gt;</returns>
        ...
        /// <returns>RecipesParseIngredientsNutritionWeightPerServing</returns>
    ...
    public class IngredientsApi : IIngredientsApi
    {
        ...
        /// <param name="intolerances">A comma-separated list of intolerances. All recipes returned must not contain ingredients that are not suitable for people with the intolerances entered. See a full list of supported intolerances.</param> 
        /// <returns>List&lt;InlineResponse20024&gt;</returns>            
        public List<InlineResponse20024> AutocompleteIngredientSearch (string query, int? number, bool? metaInformation, string intolerances)
        {
 ...
 if (intolerances != null) queryParams.Add("intolerances", ApiClient.ParameterToString(intolerances)); // query parameter
            ...
            return (List<InlineResponse20024>) ApiClient.Deserialize(response.Content, typeof(List<InlineResponse20024>), response.Headers);
        }
        ...
        /// <param name="unit">The target unit.</param> 
        /// <returns>RecipesParseIngredientsNutritionWeightPerServing</returns>            
        public RecipesParseIngredientsNutritionWeightPerServing ComputeIngredientAmount (decimal? id, string nutrient, decimal? target, string unit)
        {
 ...
 if (unit != null) queryParams.Add("unit", ApiClient.ParameterToString(unit)); // query parameter
            ...
            return (RecipesParseIngredientsNutritionWeightPerServing) ApiClient.Deserialize(response.Content, typeof(RecipesParseIngredientsNutritionWeightPerServing), response.Headers);
        }
        ...
        /// <param name="unit">The unit for the given amount.</param> 
        /// <returns>InlineResponse20022</returns>            
        public InlineResponse20022 GetIngredientInformation (int? id, decimal? amount, string unit)
        {
 ...
 if (unit != null) queryParams.Add("unit", ApiClient.ParameterToString(unit)); // query parameter
        ...
        /// <param name="ingredientName">The name of the ingredient you want to replace.</param> 
        /// <returns>InlineResponse20026</returns>            
        public InlineResponse20026 GetIngredientSubstitutes (string ingredientName)
        {
        ...
        /// <param name="id">The item&#39;s id.</param> 
        /// <returns>InlineResponse20026</returns>            
        public InlineResponse20026 GetIngredientSubstitutesByID (int? id)
        {
        ...
        /// <param name="number">The maximum number of items to return (between 1 and 100). Defaults to 10.</param> 
        /// <returns>InlineResponse20025</returns>            
        public InlineResponse20025 IngredientSearch (string query, bool? addChildren, decimal? minProteinPercent, decimal? maxProteinPercent, decimal? minFatPercent, decimal? maxFatPercent, decimal? minCarbsPercent, decimal? maxCarbsPercent, bool? metaInformation, string intolerances, string sort, string sortDirection, int? offset, int? number)
        {
 ...
 if (number != null) queryParams.Add("number", ApiClient.ParameterToString(number)); // query parameter
        ...
        /// <param name="inlineObject2"></param> 
        /// <returns>List&lt;InlineResponse20034&gt;</returns>            
        public List<InlineResponse20034> MapIngredientsToGroceryProducts (InlineObject2 inlineObject2)
        {
            
            // verify the required parameter 'inlineObject2' is set
            if (inlineObject2 == null) throw new ApiException(400, "Missing required parameter 'inlineObject2' when calling MapIngredientsToGroceryProducts");
            ...
            String postBody = null;
                                                ...
                                                postBody = ApiClient.Serialize(inlineObject2); // http body (model) parameter
            ...
            return (List<InlineResponse20034>) ApiClient.Deserialize(response.Content, typeof(List<InlineResponse20034>), response.Headers);
        }
